...
function numberOfVideos(channel) {
  ...
  //   chnnal.forEach((channal) => {
  //     sum = sum + channal.video;
  //   });
  //   console.log(sum);
...
function getChannelByName(channelName, channels) {
  return channels.find((channal) => {
    if (channal.name == channelName) return true;
  });
  // Your code here
  // retuen channels == "channelNmae"
}
...
function getChannelByVideoTitle(videoTitle, channels) {
  // Your code here
  // retuen VideoPlaybackQuality == "the Universal S"
  return channels.find((channel) => {
    return channel.videos.some((video) => {
      if (video.title == "The Universal S") {
        return true;
      }
    });
  });
...
function searchChannels(query, channels) {
  // Your code here
  let foundChannel = channels.filter((channel) => {
